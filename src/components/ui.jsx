...
export const SectionHead = ({ path, title, kicker }) => (
  <div className="mb-12 sm:mb-16">
    ...
    <h2 className="mt-6 font-grotesk text-[32px] font-bold uppercase leading-[0.95] tracking-[-0.03em] text-white sm:text-[52px]">
      {title}
    </h2>
    {kicker && <p className="lead mt-5 max-w-[60ch] sm:text-[16px]">{kicker}</p>}
  </div>
)
